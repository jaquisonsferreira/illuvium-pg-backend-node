...
import { BurnNftUseCase } from './burn-nft.use-case';
...
describe('BurnNftUseCase', () => {
  let useCase: BurnNftUseCase;
  ...
  beforeEach(async () => {
    ...
    useCase = module.get<BurnNftUseCase>(BurnNftUseCase);
  ...
  it('should create burn operation successfully', async () => {
    const request = {
  ...
  it('should create burn operation with optional amount as null', async () => {
    const request = {
      apiKeyId: '123e4567-e89b-12d3-a456-426614174000',
      tokenId: '1',
    };
